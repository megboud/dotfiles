...
function! airline#themes#tomorrow#refresh()
  ...
  let s:N1 = airline#themes#get_highlight2(['StatusText', 'bg'], ['Directory', 'fg'], 'bold')
  ...
  let s:I1 = airline#themes#get_highlight2(['StatusText', 'bg'], ['MoreMsg', 'fg'], 'bold')
  let s:I2 = s:N2
  let s:I3 = s:N3
  ...
  let s:V1 = airline#themes#get_highlight2(['StatusText', 'bg'], ['Constant', 'fg'], 'bold')
  let s:V2 = s:N2
  let s:V3 = s:N3
